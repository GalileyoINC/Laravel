...
@section('title', 'Influencer\'s Assistants - Admin')
        ...
        <div class="col-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <!-- Create Button -->
                    <div class="mb-3">
                        <a href="{{ route('web.influencer-assistant.create') }}" class="btn btn-success">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <a href="{{ route('web.influencer-assistant.index') }}" class="btn btn-default ml-2">Clear</a>
                    </form>

                    <!-- Export Button -->
                    <div class="mb-3">
                        <a href="{{ route('web.influencer-assistant.export', request()->query()) }}" class="btn btn-success">
                                    ...
                                    <tr>
                                        <td>
                                            @if($influencerAssistant->influencer)
                                                <a href="{{ route('web.user.show', $influencerAssistant->influencer) }}">
                                        ...
                                        <td>
                                            @if($influencerAssistant->assistant)
                                                <a href="{{ route('web.user.show', $influencerAssistant->assistant) }}">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <form method="POST" action="{{ route('web.influencer-assistant.destroy', ['idInfluencer' => $influencerAssistant->id_influencer, 'idAssistant' => $influencerAssistant->id_assistant]) }}" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
