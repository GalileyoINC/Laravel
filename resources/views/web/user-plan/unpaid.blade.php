            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <!-- Search Form -->
                            <form method="GET" action="{{ route('web.user-plan.unpaid') }}" class="d-inline">
                ...
                <div class="panel-body">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <a href="{{ route('web.user-plan.unpaid') }}" class="btn btn-default ml-2">Clear</a>
                    </form>

                    <!-- Export Button -->
                    <div class="mb-3">
                        <a href="{{ route('web.user-plan.export-unpaid', array_merge(request()->query(), ['exp_date' => $expDate])) }}" class="btn btn-success">
                            ...
                            <tbody>
                                @forelse($userPlans as $userPlan)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('web.user.show', $userPlan->user) }}" class="btn btn-xs btn-info" target="_blank">
