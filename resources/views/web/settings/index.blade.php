...
<div class="container-fluid">
    ...
    @if(!auth()->user()->showSettingsRO())
        <div class="d-flex justify-content-end mb-4">
            <a href="{{ route('web.settings.flush') }}" class="btn btn-success">
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="main">
            <form action="{{ route('web.settings.update-main') }}" method="POST">
                @csrf
        ...
        <div role="tabpanel" class="tab-pane" id="sms">
            <form action="{{ route('web.settings.update-sms') }}" method="POST">
                @csrf
                <fieldset class="mt-10">
        ...
        @if(!auth()->user()->showSettingsRO())
            <div role="tabpanel" class="tab-pane" id="api">
                <form action="{{ route('web.settings.update-api') }}" method="POST">
                    @csrf
                    <div class="row">
        ...
        <div role="tabpanel" class="tab-pane" id="app">
            <form action="{{ route('web.settings.update-app') }}" method="POST">
                @csrf
                <fieldset class="mt-10">
                    <legend>App</legend>
