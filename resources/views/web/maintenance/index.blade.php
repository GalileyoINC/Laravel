                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            ...
                            <div class="btn-group" role="group">
                                <a href="{{ route('web.maintenance.clear-cache') }}" class="btn btn-warning" onclick="return confirm('Are you sure you want to clear all cache?')">
                                    <i class="fas fa-trash"></i> Clear Cache
                                </a>
                                <a href="{{ route('web.maintenance.clear-logs') }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to clear all logs?')">
                                    <i class="fas fa-file-alt"></i> Clear Logs
                                </a>
                                <a href="{{ route('web.maintenance.database-maintenance') }}" class="btn btn-info" onclick="return confirm('Are you sure you want to run database maintenance?')">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <ul class="list-unstyled">
                                        <li><a href="{{ route('web.maintenance.system-info') }}" class="btn btn-link">System Information</a></li>
                                        <li><a href="{{ route('web.maintenance.queue-status') }}" class="btn btn-link">Queue Status</a></li>
                                        <li><a href="{{ route('web.maintenance.storage-status') }}" class="btn btn-link">Storage Status</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <hr>
                                    <a href="{{ route('web.maintenance.queue-status') }}" class="btn btn-info">View Queue Status</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('session-form').addEventListener('submit', function(e) {
        ...
        fetch('{{ route("web.maintenance.set-session") }}', {
            method: 'POST',
            body: formData,
            headers: {
