            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <a href="{{ route('web.credit-card.index') }}" class="btn btn-default ml-2">Clear</a>
                    </form>

                    <!-- Export Button -->
                    <div class="mb-3">
                        <a href="{{ route('web.credit-card.export', request()->query()) }}" class="btn btn-success">
                            ...
                            <tbody>
                                @forelse($creditCards as $card)
                                    <tr>
                                        ...
                                        <td>
                                            @if($card->user)
                                                <a href="{{ route('web.user.show', $card->user) }}">{{ $card->user->first_name }}</a>
                                            @else
                                                {{ $card->first_name }}
                                            @endif
                                        </td>
                                        <td>
                                            @if($card->user)
                                                <a href="{{ route('web.user.show', $card->user) }}">{{ $card->user->last_name }}</a>
                                            @else
                                                {{ $card->last_name }}
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('web.credit-card.show', $card) }}" class="btn btn-sm btn-info">
