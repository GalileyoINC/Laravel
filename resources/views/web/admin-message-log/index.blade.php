            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <div class="form-group mr-2">
                            <input type="text" name="objType" class="form-control" placeholder="Object Type" value="{{ request('objType') }}">
                        </div>
                        <div class="form-group mr-2">
                            <input type="text" name="objId" class="form-control" placeholder="Object ID" value="{{ request('objId') }}">
                        </div>
                        <div class="form-group mr-2">
                        ...
                        <a href="{{ route('web.admin-message-log.index') }}" class="btn btn-default ml-2">Clear</a>
                    </form>

                    <!-- Export Button -->
                    <div class="mb-3">
                        <a href="{{ route('web.admin-message-log.export', request()->query()) }}" class="btn btn-success">
