...
<div class="container-fluid">
    <div class="d-flex justify-content-start mb-4">
        <a href="{{ route('web.help.log') }}" class="btn btn-primary">Logs</a>
        <a href="{{ route('web.help.check-sps') }}" class="btn btn-warning ml-2">Check SPS</a>
    </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <a href="{{ route('web.help.test-modal') }}" class="JS__load_in_modal btn btn-info">You can open in modal</a>
                    <a href="{{ route('web.help.test-modal') }}" class="btn btn-primary">Or as page</a>

                    <hr>
                    <p>Use <code>return $this->renderFlash('success', 'text')</code> to show alerts. The summoned will disappear</p>

                    <a href="{{ route('web.help.test-alert', ['type' => 'success']) }}" class="JS__test_alert btn btn-success">Show success alert</a>
                    <a href="{{ route('web.help.test-alert', ['type' => 'error']) }}" class="JS__test_alert btn btn-danger">Show error alert</a>
                    <a href="{{ route('web.help.test-alert', ['type' => 'info']) }}" class="JS__test_alert btn btn-info">Show info alert</a>
                    <a href="{{ route('web.help.test-alert', ['type' => 'warning']) }}" class="JS__test_alert btn btn-warning">Show warning alert</a>
                </div>
            </div>
        </div>
...
'homeland' => 'Menzoberranzan'
    ...
    ->sendInBackground();
                    ...
                    <a href="{{ route('web.help.test-mail') }}" class="JS__test_alert btn btn-success">Send Test Mail</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {{ route('web.help.sms', ['provider' => 'twilio', 'number' => '111111', 'body' => 'TEXT']) }}
                    <br>
                    {{ route('web.help.sms', ['provider' => 'sinch', 'number' => '111111', 'body' => 'TEXT']) }}
                </div>
            </div>
        </div>
        <div class="col-md-6">
