        ...
        <div class="col-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route('web.subscription-category.update', $subscriptionCategory) }}" id="subscription">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a href="{{ route('web.subscription-category.show', $subscriptionCategory) }}" class="btn btn-default">
