        ...
        <div class="col-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <a href="{{ route('web.subscription-category.index') }}" class="btn btn-default">
                                <i class="fas fa-arrow-left"></i> Back to Categories
                            </a>
                            <a href="{{ route('web.subscription-category.edit', $subscriptionCategory) }}" class="btn btn-primary">
