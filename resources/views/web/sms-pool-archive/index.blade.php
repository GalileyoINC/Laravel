            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <a href="{{ route('web.sms-pool-archive.index') }}" class="btn btn-default ml-2">Clear</a>
                    </form>

                    <!-- Export Button -->
                    <div class="mb-3">
                        <a href="{{ route('web.sms-pool-archive.export', request()->query()) }}" class="btn btn-success">
                            ...
                            <tbody>
                                @forelse($smsPoolArchives as $smsPoolArchive)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('web.sms-pool-archive.show', $smsPoolArchive) }}" class="btn btn-xs btn-info">
