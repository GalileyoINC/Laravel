            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="panel-heading-actions">
                        <a href="{{ route('web.apple.app-transactions') }}" class="btn btn-default">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    @if(!$transaction->is_process)
                                        <form method="POST" action="{{ route('web.apple.process-transaction', $transaction) }}" class="mb-2">
                                            @csrf
                                    ...
                                    @else
                                        <form method="POST" action="{{ route('web.apple.retry-transaction', $transaction) }}" class="mb-2">
                                            @csrf
