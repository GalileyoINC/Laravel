            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <a href="{{ route('web.apple.app-transactions') }}" class="btn btn-default ml-2">Clear</a>
                    </form>

                    <!-- Export Button -->
                    <div class="mb-3">
                        <a href="{{ route('web.apple.export-app-transactions', request()->query()) }}" class="btn btn-success">
                            ...
                            <tbody>
                                @forelse($transactions as $transaction)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('web.apple.app-transaction-show', $transaction) }}" class="btn btn-sm btn-info">
                                                    <i class="fas fa-eye"></i> View
                                                </a>
                                                @if(!$transaction->is_process)
                                                    <form method="POST" action="{{ route('web.apple.process-transaction', $transaction) }}" class="d-inline">
                                                        @csrf
                                                ...
                                                @else
                                                    <form method="POST" action="{{ route('web.apple.retry-transaction', $transaction) }}" class="d-inline">
                                                        @csrf
