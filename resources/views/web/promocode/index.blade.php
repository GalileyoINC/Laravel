        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="GET" action="{{ route('web.promocode.index') }}">
                        ...
                        <div class="form-group">
                            <a href="{{ route('web.promocode.index') }}" class="btn btn-default btn-block">Clear</a>
                        </div>
                        
                        <div class="form-group">
                            <a href="{{ route('web.promocode.export', request()->query()) }}" class="btn btn-success btn-block">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="panel-heading-actions">
                        <a href="{{ route('web.promocode.create') }}" class="btn btn-success JS__load_in_modal">
                            ...
                            <tbody>
                                @forelse($promocodes as $promocode)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('web.promocode.edit', $promocode) }}" class="btn btn-xs btn-success JS__load_in_modal">
                                                    <i class="fas fa-pen-fancy fa-fw"></i>
                                                </a>
                                                <form method="POST" action="{{ route('web.promocode.destroy', $promocode) }}" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
