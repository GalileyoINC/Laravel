            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="panel-heading-actions">
                        <a href="{{ route('web.podcast.create') }}" class="btn btn-success">
                ...
                <div class="panel-body">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <a href="{{ route('web.podcast.index') }}" class="btn btn-default ml-2">Clear</a>
                    </form>

                    <!-- Export Button -->
                    <div class="mb-3">
                        <a href="{{ route('web.podcast.export', request()->query()) }}" class="btn btn-success">
                            ...
                            <tbody>
                                @forelse($podcasts as $podcast)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('web.podcast.edit', $podcast) }}" class="btn btn-xs btn-success">
