            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <a href="{{ route('web.active-record-log.index') }}" class="btn btn-default ml-2">Clear</a>
                    </form>

                    <!-- Export Button -->
                    <div class="mb-3">
                        <a href="{{ route('web.active-record-log.export', request()->query()) }}" class="btn btn-success">
                            ...
                            <tbody>
                                @forelse($activeRecordLogs as $log)
                                    <tr>
                                        ...
                                        <td>
                                            @if($log->user)
                                                <a href="{{ route('web.user.show', $log->user) }}">
