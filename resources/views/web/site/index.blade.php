                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <a href="{{ route('web.device.index') }}" class="btn btn-primary btn-block">
                                <i class="fas fa-mobile-alt"></i> View Devices
                            </a>
                        </div>
                        <div class="col-md-6 mb-3">
                            <a href="{{ route('web.email-pool.index') }}" class="btn btn-success btn-block">
                                <i class="fas fa-envelope"></i> Email Pool
                            </a>
                        </div>
                        <div class="col-md-6 mb-3">
                            <a href="{{ route('web.credit-card.index') }}" class="btn btn-info btn-block">
                                <i class="fas fa-credit-card"></i> Credit Cards
                            </a>
                        </div>
                        <div class="col-md-6 mb-3">
                            <a href="{{ route('web.api-log.index') }}" class="btn btn-warning btn-block">
