...
@section('title', 'Email Pool Details - Admin')
        ...
        <div class="col-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Email Pool #{{ $emailPool->id }}</h3>
                    <div class="panel-heading-actions">
                        <a href="{{ route('web.email-pool.index') }}" class="btn btn-default">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <form method="POST" action="{{ route('web.email-pool.resend', $emailPool) }}" class="mb-2">
                                        @csrf
                                        <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure you want to resend this mail?')">
                                            <i class="fas fa-envelope"></i> Resend
                                        </button>
                                    </form>
                                    <form method="POST" action="{{ route('web.email-pool.destroy', $emailPool) }}" class="mb-2">
                                        @csrf
                                        @method('DELETE')
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        @foreach($emailPool->attachments as $attachment)
                                            <a href="{{ route('web.email-pool.attachment', $attachment->id) }}" class="btn btn-sm btn-outline-primary mr-2 mb-2">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <iframe class="embed-responsive-item" src="{{ route('web.email-pool.view-body', $emailPool) }}"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
