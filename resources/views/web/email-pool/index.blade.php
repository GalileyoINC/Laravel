            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="panel-heading-actions">
                        <a href="{{ route('web.email-pool.archive') }}" class="btn btn-info">
                ...
                <div class="panel-body">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <a href="{{ route('web.email-pool.index') }}" class="btn btn-default ml-2">Clear</a>
                    </form>

                    <!-- Export Button -->
                    <div class="mb-3">
                        <a href="{{ route('web.email-pool.export', request()->query()) }}" class="btn btn-success">
                            ...
                            <tbody>
                                @forelse($emailPools as $emailPool)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('web.email-pool.show', $emailPool) }}" class="btn btn-sm btn-info">
                                                    <i class="fas fa-eye"></i> View
                                                </a>
                                                <form method="POST" action="{{ route('web.email-pool.destroy', $emailPool) }}" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
