...
@section('title', 'Email Pool Archive - Admin')
        ...
        <div class="col-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Email Pool Archive</h3>
                    <div class="panel-heading-actions">
                        <a href="{{ route('web.email-pool.index') }}" class="btn btn-info">
                            <i class="fas fa-inbox"></i> Common
                        </a>
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <a href="{{ route('web.email-pool.archive') }}" class="btn btn-default ml-2">Clear</a>
                    </form>
                            ...
                            <tbody>
                                @forelse($emailPools as $emailPool)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('web.email-pool.archive-show', $emailPool) }}" class="btn btn-sm btn-info">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="10" class="text-center">No archived email pools found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
