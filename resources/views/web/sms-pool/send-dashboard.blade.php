                        ...
                        <div role="tabpanel" class="tab-pane active" id="all">
                            ...
                            <table class="table table-condensed">
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('web.sms-pool.send-to-all') }}" class="btn btn-sm btn-warning">Send</a>
                                    </td>
                                    <td>
                                        <a href="{{ route('web.admin-message-log.index', ['objType' => \App\Models\System\AdminMessageLog::TO_ALL]) }}" 
                                ...
                                @foreach($byState as $stateStatistic)
                                    @if(!empty($stateStatistic->state))
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('web.sms-pool.send-to-state', ['state' => $stateStatistic->state]) }}" 
                                                   class="btn btn-sm btn-warning">Send</a>
                                            </td>
                                            <td>
                                                <a href="{{ route('web.admin-message-log.index', ['objType' => \App\Models\System\AdminMessageLog::TO_STATE, 'objId' => $stateStatistic->state]) }}" 
                                                   class="btn btn-sm btn-success JS__load_in_modal">Log</a>
                                            </td>
                                        </tr>
                                    @endif
