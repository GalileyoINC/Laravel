            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <a href="{{ route('web.emergency-tips-request.index') }}" class="btn btn-default ml-2">Clear</a>
                    </form>

                    <!-- Export Button -->
                    <div class="mb-3">
                        <a href="{{ route('web.emergency-tips-request.export', request()->query()) }}" class="btn btn-success">
                            ...
                            <tbody>
                                @forelse($emergencyTipsRequests as $emergencyTipsRequest)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('web.emergency-tips-request.show', $emergencyTipsRequest) }}" class="btn btn-xs btn-info">
