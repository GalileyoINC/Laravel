            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <a href="{{ route('web.logs.active-record-logs') }}" class="btn btn-default ml-2">Clear</a>
                    </form>

                    <!-- Export Button -->
                    <div class="mb-3">
                        <a href="{{ route('web.logs.export-active-record-logs', request()->query()) }}" class="btn btn-success">
                            ...
                            <tbody>
                                @forelse($logs as $log)
                                    <tr>
                                        ...
                                        <td>
                                            @if($log->user)
                                                <a href="{{ route('web.user.show', $log->user) }}">{{ $log->user->getFullName() }} ({{ $log->user->id }})</a>
                                            @else
                                                -
                                            @endif
                                        </td>
