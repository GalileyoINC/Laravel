            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        @include('contract-line._unpaid_search', ['expDateDays' => $expDateDays])
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <a href="{{ route('contract-line.unpaid') }}" class="btn btn-default ml-2">Clear</a>
                    </form>

                    <!-- Export Button -->
                    <div class="mb-3">
                        <a href="{{ route('contract-line.export-unpaid', request()->query()) }}" class="btn btn-success">
