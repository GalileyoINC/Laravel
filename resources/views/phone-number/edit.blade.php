...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Edit Phone Number #{{ $phoneNumber->id }}</h3>
    </div>
    
    <form action="{{ route('phone-number.update', $phoneNumber) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="id_user" name="id_user" value="{{ old('id_user', $phoneNumber->id_user) }}">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="type" name="type">
                            <option value="1" {{ old('type', $phoneNumber->type) == '1' ? 'selected' : '' }}>Mobile</option>
                            <option value="2" {{ old('type', $phoneNumber->type) == '2' ? 'selected' : '' }}>Landline</option>
                            <option value="3" {{ old('type', $phoneNumber->type) == '3' ? 'selected' : '' }}>Satellite</option>
                        </select>
                    </div>
                </div>
