            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="panel-heading-actions">
                        <a href="{{ route('iex.create-marketstack') }}" class="btn btn-success JS__load_in_modal">
                ...
                <div class="panel-body">
                    ...
                    <form method="GET" class="form-inline mb-3">
                        ...
                        <a href="{{ route('iex.marketstack') }}" class="btn btn-default ml-2">Clear</a>
                    </form>

                    <!-- Export Button -->
                    <div class="mb-3">
                        <a href="{{ route('iex.export-marketstack', request()->query()) }}" class="btn btn-success">
                            ...
                            <tbody>
                                @forelse($indexes as $index)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('iex.marketstack-show', $index) }}" class="btn btn-sm btn-info">
                                                    <i class="fas fa-eye"></i> View
                                                </a>
                                                <a href="{{ route('iex.edit-marketstack', $index) }}" class="btn btn-sm btn-primary JS__load_in_modal">
