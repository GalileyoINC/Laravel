...
@section('title', 'Super Update Subscription - Admin')
        ...
        <div class="col-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Super Update Subscription: {{ $subscription->title }}</h3>
                </div>
                <div class="panel-body">
                    <form id="subscription" method="POST" action="{{ route('subscription.update', $subscription) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
