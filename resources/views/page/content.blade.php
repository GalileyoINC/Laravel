...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('page.edit', $page) }}" class="btn btn-secondary">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ isset($pageContent) ? route('page.update-content', ['page' => $page, 'pageContent' => $pageContent]) : route('page.store-content', $page) }}" method="POST">
                @csrf
