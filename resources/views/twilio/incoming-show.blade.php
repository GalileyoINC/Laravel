                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <a href="{{ route('twilio.edit-incoming', $incoming) }}" class="btn btn-primary JS__load_in_modal mb-2">
                                        <i class="fas fa-pen-fancy"></i> Update
                                    </a>
                                    <form method="POST" action="{{ route('twilio.delete-incoming', $incoming) }}" class="d-inline">
                                        @csrf
                                        @method('DELETE')
