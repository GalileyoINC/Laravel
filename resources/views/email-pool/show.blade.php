            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="panel-heading-actions">
                        <a href="{{ route('email-pool.index') }}" class="btn btn-default">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <form method="POST" action="{{ route('email-pool.resend', $emailPool) }}" class="mb-2">
                                        @csrf
                                    ...
                                    <form method="POST" action="{{ route('email-pool.destroy', $emailPool) }}" class="mb-2">
                                        @csrf
                                        @method('DELETE')
