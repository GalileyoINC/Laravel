...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Edit Bundle #{{ $bundle->id }}</h3>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control" id="total" name="total" value="{{ old('total', $bundle->total) }}" required>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="type" name="type">
                            <option value="1" {{ old('type', $bundle->type) == '1' ? 'selected' : '' }}>Standard</option>
                            <option value="2" {{ old('type', $bundle->type) == '2' ? 'selected' : '' }}>Premium</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="pay_interval" name="pay_interval">
                            <option value="1" {{ old('pay_interval', $bundle->pay_interval) == '1' ? 'selected' : '' }}>Monthly</option>
                            <option value="2" {{ old('pay_interval', $bundle->pay_interval) == '2' ? 'selected' : '' }}>Yearly</option>
                        </select>
                    </div>
                </div>
