            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="panel-heading-actions">
                        <a href="{{ route('credit-card.index') }}" class="btn btn-default">
                        ...
                        <div class="col-md-6">
                            ...
                            @if($creditCard->user)
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <a href="{{ route('user.show', $creditCard->user) }}" class="btn btn-primary btn-sm">
                            ...
                            @if($creditCard->anet_customer_payment_profile_id)
                                <div class="panel panel-warning">
                                    ...
                                    <div class="panel-body">
                                        <a href="{{ route('credit-card.get-gateway-profile', $creditCard) }}" class="btn btn-admin">
