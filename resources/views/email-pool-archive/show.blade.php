                        ...
                        <div class="col-12">
                            ...
                            <div class="panel-body">
                                @foreach($emailPoolArchive->attachments as $attachment)
                                    <a href="{{ route('email-pool-archive.attachment', $attachment) }}" class="btn btn-sm btn-outline-primary mr-2 mb-2">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            ...
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item" src="{{ route('email-pool-archive.view-body', $emailPoolArchive) }}"></iframe>
                            </div>
                        </div>
                    </div>
