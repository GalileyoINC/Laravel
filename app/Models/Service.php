...
class Service extends Model
{
	...
	{
		return $this->hasMany(UserPlan::class, 'id_service');
	}

	public function user_plan_shedules()
	{
		return $this->hasMany(UserPlanShedule::class, 'id_service');
	}

	public function users()
	{
		return $this->belongsToMany(User::class, 'user_service', 'id_service', 'id_user');
	}
}
