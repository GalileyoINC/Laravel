...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany(AffiliateInvite::class, 'id_user');
    }

    public function bp_subscriptions()
    {
        return $this->hasMany(BpSubscription::class, 'id_user');
    }
    ...
    {
        return $this->hasMany(ContractLine::class, 'id_user');
    }

    public function conversation_messages()
    {
        return $this->hasMany(ConversationMessage::class, 'id_user');
    }

    public function conversations()
    {
        return $this->belongsToMany(Conversation::class, 'conversation_user', 'id_user', 'id_conversation');
    }

    public function credit_cards()
    {
        return $this->hasMany(CreditCard::class, 'id_user');
    }
    ...
    {
        return $this->hasMany(Follower::class, 'id_user_leader');
    }

    public function follower_lists()
    {
        return $this->hasMany(FollowerList::class, 'id_user');
    }

    public function influencer_assistants()
    {
        return $this->hasMany(InfluencerAssistant::class, 'id_influencer');
    }
    ...
    {
        return $this->hasMany(InviteAffiliate::class, 'id_inviter');
    }
    ...
    {
        return $this->hasMany(LogAuthorize::class, 'id_user');
    }

    public function login_statistics()
    {
        return $this->hasMany(LoginStatistic::class, 'id_user');
    }
    ...
    {
        return $this->hasMany(MoneyTransaction::class, 'id_user');
    }
    ...
    {
        return $this->hasMany(SmsPool::class, 'id_user');
    }

    public function sms_pool_phone_numbers()
    {
        return $this->hasMany(SmsPoolPhoneNumber::class, 'id_user');
    }

    public function sms_pool_reactions()
    {
        return $this->hasMany(SmsPoolReaction::class, 'id_user');
    }

    public function sms_shedules()
    {
        return $this->hasMany(SmsShedule::class, 'id_user');
    }
    ...
    {
        return $this->hasMany(SpsContract::class, 'id_user');
    }

    public function subscriptions()
    {
        return $this->belongsToMany(Subscription::class, 'user_subscription_address', 'id_user', 'id_subscription')
            ->withPivot('id', 'zip');
    }

    public function subscription_wizards()
    {
        return $this->hasMany(SubscriptionWizard::class, 'id_user');
    }

    public function users()
    {
        return $this->hasMany(User::class, 'id_inviter');
    }

    public function user_follower_alerts()
    {
        return $this->hasMany(UserFollowerAlert::class, 'id_user');
    }
    ...
    {
        return $this->belongsToMany(Service::class, 'user_service', 'id_user', 'id_service');
    }
}
